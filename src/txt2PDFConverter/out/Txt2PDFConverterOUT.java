...
import txt2PDFConverter.IFileSelector;
 ...
 */
public class Txt2PDFConverterOUT extends JFrame implements IFileSelector {
	...
	private Txt2PDFConverterOUT() {
		...
		this.inputBrowseB = new JButton(inputBrowseAction);
		JPanel inputP = new JPanel();
		inputP.add(inputTF);
		inputP.add(inputBrowseB);
		this.outputBrowseB = new JButton(outputBrowseAction);
		...
		this.commonPanel = new CommonPanel(this, this);
	...
	private AbstractAction inputBrowseAction = new AbstractAction("Browse") {
		private static final long serialVersionUID = 1L;
		public void actionPerformed(ActionEvent e) {
			int returnVal = txtFileChooser.showOpenDialog(Txt2PDFConverterOUT.this);
	...
	private AbstractAction outputBrowseAction = new AbstractAction("Browse") {
		private static final long serialVersionUID = 1L;
		public void actionPerformed(ActionEvent e) {
			int returnVal = pdfFileChooser.showOpenDialog(Txt2PDFConverterOUT.this);
			if(returnVal== JFileChooser.APPROVE_OPTION) {
				System.out.println("You chose to open this file: "
	...
	public static void main(String[] args) {
			...
			SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					Txt2PDFConverterOUT txt2PDFConverterOUT = new Txt2PDFConverterOUT();
				}
			});
		}
	}
